...
<?php
    ...
    if(isset($_GET['ticket'])){
       login('leboncoin/compte/reservations', $_GET['ticket'], false);
    } else {
       login('leboncoin/compte/reservations', null, false);
    }
    ...
    if (isset($_GET['sort'])) {
        $sort = $_GET['sort'];
        $reservations = getReservationsParEtu($user['idetu']);
        if ($sort != 'all') {
    ...
    <div id="annonces" class="annonces">
        ...
        <div class="sort">
            <div class="sort-dropdown">
                ...
                <button onclick="window.location.href='reservationsannonces.php'">Voir les réservations de mes annonces</button>
            </div>
            </div>
        <?php
            if (!$commandes) {
                ...
                foreach ($commandes as $commande) {
                    ...
                    echo '<div class="annonce-item" onclick="window.location.href=\'reservation.php?id='.$commande->idreservation.'\'">';
