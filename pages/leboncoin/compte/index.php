...
<div class="container">
    <div class="formContainer">
        ...
        <div class="button-group">
            <a href="/RT/A23/pages/leboncoin/annonces/create.php" class="button">Déposer une annonce</a>
            <a href="/RT/A23/pages/leboncoin/compte/reservationsannonces.php" class="button">Réservations de mes annonces</a>
            <a href="/RT/A23/pages/leboncoin/compte/delete.php" class="button">Supprimer mon compte</a>
        </div>
