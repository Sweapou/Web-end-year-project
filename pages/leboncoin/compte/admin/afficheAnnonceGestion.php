...
<body>
    <?php
        ...
        echo '</div>';
        echo '<hr>';
        echo '<button class="annonce-vendeur-btn" onclick="window.location.href=\'../../annonces/editAdmin.php?id='.$annonce["idannonce"].'\'">Modifier</button>';
        echo '<button class="annonce-vendeur-btn" onclick="window.location.href=\'../../annonces/deleteAdmin.php?id='.$annonce["idannonce"].'\'">Supprimer</button>';
        echo '</div>';
        echo '</div>';
        echo '</div>';
        echo '<hr>';
