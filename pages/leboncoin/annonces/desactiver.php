...
<head>
    ...
    <title>Desafficher Annonce</title>
...
<body>
    ...
    if (isset($_POST['confirm']) && isset($_GET['id'])) {     
        ...
        if (!checkOwnerAnnonce($id)) {
            ...
            echo '<p>Vous ne pouvez pas ne plus afficher cette annonce car elle ne vous appartient pas</p>';
        ...
        echo '<div class="container">';
        echo '<div class="delete-container">';
        echo '<p>Etes vous sur de plus vouloir afficher cette annonce ?</p>';
